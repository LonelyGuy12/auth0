  ...
  Future<void> _toggleRecording() async {
    ...
    if (!started) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
              'Microphone access denied. Please allow mic access in Windows Settings.'),
  ...
  Widget build(BuildContext context) {
    return Consumer<ChatProvider>(
      builder: (context, chat, _) {
        ...
        final micBusy = _isRecording || _isTranscribing;
                  ...
                  Expanded(
                    child: KeyboardListener(
                      ...
                      child: TextField(
                        ...
                        enabled: !isLoading && !_isTranscribing,
                        maxLines: 5,
                        minLines: 1,
                        style: const TextStyle(
                        ...
                        child: AnimatedContainer(
                          ...
                          child: AnimatedSwitcher(
                            ...
                            child: Icon(
                              ...
                              key: ValueKey(
                                  isLoading || _controller.text.trim().isEmpty),
                              color: isLoading ||
...
/// A small dot that pulses to indicate active recording.
